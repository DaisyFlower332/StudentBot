...
/** One square on the card: short label on the tile, clue shown at the top. */
export type BingoCellData = {
  answer: string;
  clue: string;
};

export type BingoTopicId = "vocabulary" | "maths" | "science";

export const BINGO_VOCABULARY: BingoCellData[] = [
  { answer: "Brave", clue: "Means you show courage when something is scary." },
  { answer: "Curious", clue: "You want to learn and ask lots of questions." },
  { answer: "Gentle", clue: "Nice and careful — not rough." },
  { answer: "Huge", clue: "Another word for extremely big." },
  { answer: "Whisper", clue: "Speak so quietly that only people close can hear." },
  { answer: "Harvest", clue: "Farmers gather crops at this time of year." },
  { answer: "Journey", clue: "A trip from one place to another." },
  { answer: "Mystery", clue: "Something hard to figure out or explain." },
  { answer: "Recycle", clue: "Use something again instead of throwing it away." },
  { answer: "Ancient", clue: "Means very old — from long, long ago." },
  { answer: "Planet", clue: "A big ball in space that orbits a star." },
  { answer: "Forest", clue: "Land covered with many trees." },
  { answer: "Desert", clue: "A very dry place — often hot and sandy." },
  { answer: "Library", clue: "A building full of books you can read." },
  { answer: "Scientist", clue: "Someone who studies how nature works." },
  { answer: "Telescope", clue: "Tool for looking at moons and stars far away." },
  { answer: "Friendly", clue: "Being kind and welcoming to others." },
  { answer: "Clever", clue: "Quick to learn and solve little problems." },
  { answer: "Grateful", clue: "Feeling thankful for someone's help." },
  { answer: "Explorer", clue: "Someone who travels to discover new places." },
  { answer: "Puzzle", clue: "Something you have to think hard to solve." },
  { answer: "Fierce", clue: "Strong and wild — like a storm or tiger." },
  { answer: "Habitat", clue: "The natural home where an animal lives." },
  { answer: "Drowsy", clue: "Sleepy and ready for a nap." },
  { answer: "Magnets", clue: "Stick to things made of iron." },
  { answer: "Blossom", clue: "Flower on a tree — often in spring." },
  { answer: "Echo", clue: "Sound that bounces back so you hear it twice." },
  { answer: "Gloomy", clue: "Gray, dark, or unhappy weather or mood." },
  { answer: "Riddle", clue: "A tricky question or word puzzle." },
  { answer: "Tremble", clue: "Shake a little because you're cold or scared." },
];

export const BINGO_MATHS: BingoCellData[] = [
  { answer: "56", clue: "What is 7 × 8?" },
  { answer: "12", clue: "How many months are in one year?" },
  { answer: "100", clue: "Ten tens make this number." },
  { answer: "24", clue: "Half of 48 is…" },
  { answer: "9", clue: "How many lives does a cat have in the old saying?" },
  { answer: "60", clue: "Minutes in one hour." },
  { answer: "4", clue: "Sides on a square." },
  { answer: "3", clue: "Sides on a triangle." },
  { answer: "90", clue: "Degrees in a right angle." },
  { answer: "144", clue: "12 × 12" },
  { answer: "365", clue: "Roughly how many days in a normal year?" },
  { answer: "81", clue: "Nine squared (9 × 9)" },
  { answer: "0", clue: "What's 5 minus 5?" },
  { answer: "36", clue: "Six times six" },
  { answer: "72", clue: "Eight times nine" },
  { answer: "20", clue: "Five times four" },
  { answer: "110", clue: "Nine plus one hundred and one" },
  { answer: "999", clue: "Biggest three-digit whole number" },
  { answer: "125", clue: "Five × five × five" },
  { answer: "180", clue: "Degrees in a half turn (straight line)" },
  { answer: "54", clue: "Nine times six" },
  { answer: "121", clue: "Eleven times eleven" },
  { answer: "66", clue: "Six times eleven" },
  { answer: "96", clue: "Twelve times eight" },
  { answer: "132", clue: "Eleven times twelve" },
  { answer: "108", clue: "Twelve times nine" },
  { answer: "216", clue: "Six cubed (6 × 6 × 6)" },
  { answer: "625", clue: "Twenty-five times twenty-five" },
  { answer: "1000", clue: "Ten hundred" },
];

export const BINGO_SCIENCE: BingoCellData[] = [
  { answer: "Water", clue: "Plants soak this up through their roots." },
  { answer: "Roots", clue: "Part of the plant mostly hidden under soil." },
  { answer: "Photosynthesis", clue: "How green plants turn sunlight into food." },
  { answer: "Mars", clue: "The red planet." },
  { answer: "Jupiter", clue: "Huge gas giant with the Great Red Spot." },
  { answer: "Mercury", clue: "Smallest planet in our solar system." },
  { answer: "Friction", clue: "Rubbing that slows a sled on snow." },
  { answer: "Gravity", clue: "Pulls your feet toward the Earth's centre." },
  { answer: "Solid", clue: "State of ice at room temperature — not flowing." },
  { answer: "Liquid", clue: "State of drinkable water." },
  { answer: "Gas", clue: "State of helium in a balloon — hard to see." },
  { answer: "Evaporation", clue: "When puddles disappear on a warm day." },
  { answer: "Condensation", clue: "Water droplets forming on a cold window." },
  { answer: "Seed", clue: "Can grow into a new plant." },
  { answer: "Chlorophyll", clue: "Green stuff in leaves that catches sunlight." },
  { answer: "Oxygen", clue: "Gas we breathe in from the air." },
  { answer: "Carbon dioxide", clue: "Gas plants take in and we breathe out." },
  { answer: "Volcano", clue: "Mountain that can spill hot lava." },
  { answer: "Fossil", clue: "Very old remains of a plant or animal in rock." },
  { answer: "Orbit", clue: "The path the Earth takes around the Sun." },
  { answer: "Moon", clue: "Natural object that orbits the Earth." },
  { answer: "Star", clue: "Our Sun is one of these." },
  { answer: "Cell", clue: "Tiny building block of living things." },
  { answer: "Sound", clue: "Travels as waves you hear with your ears." },
  { answer: "Light", clue: "Lets you see — travels very fast." },
  { answer: "Magnet", clue: "Attracts paper clips made of steel." },
  { answer: "Brain", clue: "Organ that helps you think and remember." },
  { answer: "Heart", clue: "Pumps blood around your body." },
  { answer: "Lungs", clue: "Organs that take oxygen from the air." },
  { answer: "Seasons", clue: "Spring, summer, autumn, and winter." },
];
